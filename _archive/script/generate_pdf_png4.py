...
FORCE_A_FORMAT = 'A0'          # None, 'A0', or 'A1'
FORCE_ORIENTATION = 'vertical' # 'vertical' or 'horizontal'

MIN_WIDTH_PX = 9933  # Desired minimum PNG width in pixels

# === Constants for A formats in mm ===
A_SIZES = {
    'A0': (841, 1189),  # width x height in mm (vertical)
    'A1': (594, 841),
}
...
for svg_path in svg_dir.glob("*.svg"):
    ...
    try:
        ...
        if FORCE_A_FORMAT in A_SIZES:
            # Choose fixed A paper size
            paper_w, paper_h = A_SIZES[FORCE_A_FORMAT]
            if FORCE_ORIENTATION == 'horizontal':
